...
int sub_menu_display01(void); // 햄버거 메뉴 출력
int sub_menu_display02(void); // 스파게티 메뉴 출력
void sub_main01(void);        // 햄버거 메뉴 제어
void sub_main02(void);        // 스파게티 메뉴 제어
void chicken_burger(void);
void cheese_burger(void);
void tomato_spaghetti(void);
void cream_spaghetti(void);
void press_any_key(void);     // 아무 키나 누르면 이전 메뉴로
